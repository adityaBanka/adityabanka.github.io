  ...
  return (
    <div className='flex flex-col justify-center items-center bg-gray-100 h-full min-h-screen py-20 lg:pt-60 space-y-20 '>
      ...
      <div className="flex md:flex-row flex-col justify-center items-center bg-white/50 backdrop-blur-2xl rounded-2xl lg:rounded-4xl mx-[5%] drop-shadow-xl p-[2%] animate-fade-in-up ">
        <img src="AdityaBanka.jpg" className=' md:w-1/3 lg:w-1/4 h-auto rounded-4xl m-5 pointer-events-none select-none outline-5 outline-white/50 shadow-2xl' alt="Aditya Banka" />
