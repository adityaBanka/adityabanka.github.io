  ...
  return (
    <div className='flex flex-col justify-center items-center bg-gray-100 h-full min-h-screen py-20 lg:pt-60 space-y-20 '>
      ...
      <div className="flex md:flex-row flex-col justify-center items-center bg-white/50 backdrop-blur-2xl rounded-2xl lg:rounded-4xl mx-[5%] drop-shadow-xl p-[2%] animate-fade-in-up ">
        <img src="AdityaBanka.jpg" className=' md:w-1/3 lg:w-1/4 h-auto rounded-xl lg:rounded-2xl m-[1%] pointer-events-none select-none shadow-2xl' alt="Aditya Banka" />
        <div className="flex flex-col m-5">
          <span className="mb-5 text-3xl font-semibold text-gray-800">&quot;He&apos;s the <span className="text-indigo-500 text-5xl">Jack</span> of all, and a <span className="text-green-600 text-5xl">Master</span> of many..&quot;<span className="text-xl text-nowrap"> - My dad</span> </span>
